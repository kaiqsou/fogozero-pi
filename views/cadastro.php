...
?>
        ...
        <div class="cadastrar-form" id="cadastrar-form">
            ...
            <form id="cadastroForm" method="POST" action="index.php?controle=usuarioController&metodo=cadastro">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cadastro-nome" name="cadastro-nome" placeholder="Digite o seu nome">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" class="form-control" id="cadastro-email" name="cadastro-email" placeholder="Digite o seu email">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cadastro-cep" id="cadastro-cep" placeholder="Seu CEP"><br>
                            </div>
                            <div class="col">
                                <label for="cadastro-cidade" class="form-label">Cidade</label>
                                <input type="text" class="form-control" name="cadastro-cidade" id="cadastro-cidade" placeholder="Sua cidade"><br>
                            </div>
                            <!-- É melhor a seleção de estado padrão ou como select? -->
                            <div class="col">
                                <label for="cadastro-estado" class="form-label">Estado</label>
                                <input type="text" class="form-control" name="cadastro-estado" id="cadastro-estado" placeholder="Seu estado"><br>
                            </div>
                        </div>

                        <label for="cadastro-rua" class="form-label">Rua</label>
                        <input type="text" class="form-control" name="cadastro-rua" id="cadastro-rua" placeholder="Nome da rua"><br>

                        <div class="row">
                            <div class="col">
                                <label for="cadastro-bairro" class="form-label">Bairro</label>
                                <input type="text" class="form-control" name="cadastro-bairro" id="cadastro-bairro" placeholder="Nome do bairro"><br>
                            </div>
                            <div class="col">
                                <label for="cadastro-numero" class="form-label">Número</label>
                                <input type="text" class="form-control" name="cadastro-numero" id="cadastro-numero" placeholder="Número da residência"><br>   
                            </div>
                        <div>
                    </div>
                </div>
    ...
    <script>
        function verificar(elemento)
        {
            if (elemento.checked)
            {
                // fazer os campos de endereço se tornarem obrigatorios caso a checkbox esteja marcada
