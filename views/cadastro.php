        ...
        <div class="cadastrar-form" id="cadastrar-form">
            ...
            <form id="cadastroForm" method="POST" action="index.php?controle=usuarioController&metodo=cadastro">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cadastro-nome" name="cadastro-nome" placeholder="Digite o seu nome" value="<?php echo $nome; ?>">   
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" class="form-control" id="cadastro-email" name="cadastro-email" placeholder="Digite o seu email" value="<?php echo $email; ?>">
                    <div style='color:red;font-size:12px;'><?php echo $msg[1];?></div>
                </div>
                <div class="form-group mb-3">
                    <label for="cadastro-tel" class="form-label">Número de telefone</label>
                    <input type="tel" class="form-control" id="cadastro-tel" name="cadastro-telefone" placeholder="Digite o seu telefone" value="<?php echo $telefone; ?>">
                </div>
                <div class="form-group mb-3">
                    <label for="cadastro-senha" class="form-label">Senha</label>
                    <input type="password" class="form-control" id="cadastro-senha" name="cadastro-senha" placeholder="Crie uma senha">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cadastro-cep" id="cadastro-cep" placeholder="Seu CEP" value="<?php echo $cep; ?>"><br>
                            </div>
                            <div class="col">
                                <label for="cadastro-cidade" class="form-label">Cidade</label>
                                <input type="text" class="form-control" name="cadastro-cidade" id="cadastro-cidade" placeholder="Sua cidade" value="<?php echo $cidade; ?>"><br>
                            </div>
                            <!-- É melhor a seleção de estado padrão ou como select? -->
                            <div class="col">
                                <label for="cadastro-estado" class="form-label">Estado</label>
                                <input type="text" class="form-control" name="cadastro-estado" id="cadastro-estado" placeholder="Seu estado" value="<?php echo $estado; ?>"><br>
                            </div>
                        </div>

                        <label for="cadastro-rua" class="form-label">Rua</label>
                        <input type="text" class="form-control" name="cadastro-rua" id="cadastro-rua" placeholder="Nome da rua" value="<?php echo $rua; ?>"><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="cadastro-numero" id="cadastro-numero" placeholder="Número da residência" value="<?php echo $numero; ?>"><br>   
                            </div>
                        <div>
                    </div>
                </div>
